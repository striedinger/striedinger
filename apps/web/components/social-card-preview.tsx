...
export function SocialCardPreview({ metadata, platform, title }: SocialCardPreviewProps) {
    ...
    return (
      ...
      >
        ...
        <article className="overflow-hidden rounded-2xl border border-border/70 bg-card shadow-sm">
          ...
          <div className="flex flex-col gap-0.5 border-t border-border/70 px-3 py-2.5">
            <Text size="xs" tone="muted" className="truncate">
              {sourceHostname}
            </Text>
            <Text as="h3" size="sm" numberOfLines={2}>
              {cardTitle}
            </Text>
          </div>
        </article>
